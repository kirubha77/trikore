...
@section('content')
	<div role="main" class="main">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 670, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'parallax': { 'type': 'scroll', 'origo': 'enterpoint', 'speed': 1000, 'levels': [2,3,4,5,6,7,8,9,12,50], 'disable_onmobile': 'on' }, 'navigation' : {'arrows': { 'enable': false }, 'bullets': {'enable': true, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
						<ul>
							<li class="slide-overlay slide-overlay-primary" data-transition="fade">
								<img src="{{ asset('assets/img/slides/slide-corporate-1-1.jpg') }}"  
									alt=""
							...
							<li class="slide-overlay" data-transition="fade">
								<img src="{{ asset('assets/img/slides/slide-corporate-1-2.jpg') }}"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
				...
				<section class="section section-parallax section-height-3 border-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 7, 'parallaxHeight': '150%', 'offset': 100}" data-image-src="{{ asset('assets/img/parallax/parallax-corporate-1-1.jpg') }}">
				...
				<div class="container">
					...
					<div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
						<div class="col-md-4 mb-4 mb-md-0">
							<img class="img-fluid scale-2 pr-5 pr-md-0 my-4" src="{{ asset('assets/img/layout-styles.png') }}" alt="layout styles" />
						</div>
					...
					<div class="row align-items-center py-5 appear-animation" data-appear-animation="fadeInRightShorter">
						...
						<div class="col-md-4 px-5 px-md-3">
							<img class="img-fluid scale-2 my-4" src="{{ asset('assets/img/style-switcher.png') }}" alt="style switcher" />
						</div>
					</div>
							...
							<a href="">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('assets/img/projects/project.jpg') }}" class="img-fluid" alt="">
					...
					<div class="isotope-item">
						<div class="image-gallery-item mb-0">
							<a href="">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('assets/img/projects/project-2.jpg') }}" class="img-fluid" alt="">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Project Title</span>
											<span class="thumb-info-type">Project Type</span>
										</span>
					...
					<div class="isotope-item">
						<div class="image-gallery-item mb-0">
							<a href="">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('assets/img/projects/project-4.jpg') }}" class="img-fluid" alt="">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Project Title</span>
											<span class="thumb-info-type">Project Type</span>
										</span>
					...
					<div class="isotope-item">
						<div class="image-gallery-item mb-0">
							<a href="">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('assets/img/projects/project-5.jpg') }}" class="img-fluid" alt="">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Project Title</span>
											<span class="thumb-info-type">Project Type</span>
										</span>
					...
					<div class="isotope-item">
						<div class="image-gallery-item mb-0">
							<a href="">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('assets/img/projects/project-6.jpg') }}" class="img-fluid" alt="">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Project Title</span>
											<span class="thumb-info-type">Project Type</span>
										</span>
				...
				<div class="container">
					...
					<div class="row text-center mt-5 pb-5 mb-5">
						<div class="owl-carousel owl-theme carousel-center-active-item mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '476': {'items': 1}, '768': {'items': 5}, '992': {'items': 7}, '1200': {'items': 7}}, 'autoplay': true, 'autoplayTimeout': 3000, 'dots': false}">
							<div>
								<img class="img-fluid" src="{{ asset('assets/img/logos/logo-1.png') }}" alt="">
							</div>
							<div>
								<img class="img-fluid" src="{{ asset('assets/img/logos/logo-2.png') }}" alt="">
							</div>
							<div>
								<img class="img-fluid" src="{{ asset('assets/img/logos/logo-3.png') }}" alt="">
							</div>
							<div>
								<img class="img-fluid" src="{{ asset('assets/img/logos/logo-4.png') }}" alt="">
							</div>
							<div>
								<img class="img-fluid" src="{{ asset('assets/img/logos/logo-5.png') }}" alt="">
							</div>
							<div>
								<img class="img-fluid" src="{{ asset('assets/img/logos/logo-6.png') }}" alt="">
							</div>
							<div>
								<img class="img-fluid" src="{{ asset('assets/img/logos/logo-4.png') }}" alt="">
							</div>
